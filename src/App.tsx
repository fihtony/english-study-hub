	...
	return (
		<div className="flex flex-col min-h-dvh bg-background text-on-surface">
			...
			<header className="bg-surface-container-lowest border-b border-outline-variant sticky top-0 z-50">
				<div className="max-w-container-max mx-auto w-full px-6 py-4 flex items-center justify-between">
			...
			<footer className="bg-surface border-t border-outline-variant">
				<div className="max-w-container-max mx-auto w-full px-8 py-12 flex flex-col md:flex-row justify-between items-center gap-stack-md">
