    ...
    <header className="bg-white border-b border-gray-100 fixed top-0 left-0 right-0 z-50">
      <div className="flex items-center justify-between px-6 py-4 max-w-[1120px] mx-auto w-full">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a className="font-['Work_Sans'] text-sm font-medium tracking-tight text-slate-600 hover:text-teal-600 transition-colors duration-200 cursor-pointer">
            Lessons
          </a>
          <a className="font-['Work_Sans'] text-sm font-medium tracking-tight text-slate-600 hover:text-teal-600 transition-colors duration-200 cursor-pointer">
            Flashcards
          ...
          <a className="font-['Work_Sans'] text-sm font-medium tracking-tight text-teal-600 border-b-2 border-teal-600 pb-1 cursor-pointer">
            Library
          </a>
        </nav>
