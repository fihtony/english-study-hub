const TopNavBar = () => {
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-gray-100 fixed top-0 left-0 right-0 z-50">
      <div className="flex items-center justify-between px-6 py-4 max-w-[1120px] mx-auto w-full">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a
            className="font-body-ui text-sm font-medium tracking-tight text-teal-600 dark:text-slate-400 border-b-2 border-teal-600 pb-1 cursor-pointer"
            href="#"
          >
            Library
          </a>
