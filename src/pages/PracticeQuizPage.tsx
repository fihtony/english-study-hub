...
// Arrow icon SVG to replace material-symbols-outlined
...
const PracticeQuizPage: React.FC = () => {
  const [selectedOption, setSelectedOption] = React.useState<string>('have been gathering');
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
        ...
        <div className="w-full max-w-2xl bg-surface-container-lowest border border-outline-variant p-stack-lg shadow-sm">
          ...
          <div className="space-y-stack-lg">
            ...
            <form className="space-y-stack-md">
              {options.map((option) => (
                <label key={option} className="group flex items-center p-stack-md border border-outline-variant hover:border-secondary transition-colors cursor-pointer bg-white">
                  <input
      ...
      {/* Footer */}
      <footer className="bg-slate-50 border-t border-gray-200 dark:bg-slate-950 dark:border-gray-800 full-width bottom-0">
