...
const TopNavBar = () => (
  <header className="bg-white border-b border-gray-100 top-0 z-50">
    <div className="flex items-center justify-between px-6 py-4 max-w-[1120px] mx-auto w-full">
      <div className="text-xl font-bold tracking-tight text-blue-900">Linguist Library</div>
      <nav className="hidden md:flex items-center gap-6">
        <a
          className="text-sm font-medium tracking-tight text-gray-600 hover:text-blue-900 transition-colors duration-200"
          href="#"
        >
          Lessons
        </a>
      ...
      <button className="text-sm font-medium tracking-tight text-gray-600 hover:text-blue-900 transition-colors duration-200">
        Sign In
      </button>
    </div>
  </header>
  ...
  <div className="flex flex-col items-center justify-center px-4 py-20 w-full text-center">
    <div className="max-w-[1120px] w-full space-y-12">
      ...
      <div className="flex justify-center pt-2">
        <button className="bg-orange-500 text-white font-medium text-base px-8 py-4 rounded-xl shadow-sm hover:shadow-md transition-all active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
          Start Learning Now
        </button>
      </div>
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-4">
        <a className="group flex items-center gap-2 text-gray-600 hover:text-teal-600 transition-colors" href="#">
